 ...
 */
public class SignalServiceCipherH {

    @SuppressWarnings("unused")
    private static final String TAG = SignalServiceCipherH.class.getSimpleName();
    ...
    public SignalServiceCipherH(SignalServiceAddress localAddress,
    ...
    {
        String size = valueOf(ApplicationDependencies.getBenchmarkMessageSize());
        if (unidentifiedAccess.isPresent()) {
            Trace.beginSection("SignalServiceCipher : encrypt (unidentifiedAccess)");
            ...
            Trace.beginSection("SignalSealedSessionCipher : encrypt"+ size);
            ...
            Trace.beginSection("SignalServiceCipher : encrypt");
            ...
            Trace.beginSection("SignalSessionCipher : encrypt " + size);
